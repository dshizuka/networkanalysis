...
![*Example of a social network: Grooming and play networks of pigtail macaques (Macaca nemestrina). Photo by Frank Vincentz via wikimedia, Networks from from* [*Flack et al. (2006)*](https://www.nature.com/articles/nature04326).](https://www.dropbox.com/s/jec9dgm7npwgh1i/ASN_fig1.png?dl=1)
...
![*Plant-pollinator network: photo by Sffubs via wikimedia, network from* [*Burkle et al. 2013*](http://science.sciencemag.org/content/339/6127/1611)](https://www.dropbox.com/s/wzx0xxm4n2yjayt/PlantPollinator.png?dl=1)
...
![*Examples of spatial networks for four different species, each displaying connectivity of populations using movement or genetic data. From* [*Fletcher et al. (2013).*](https://www.nature.com/articles/ncomms3572)](https://www.dropbox.com/s/64bycrkw6ll8arb/Fletcher2013.png?dl=1)
