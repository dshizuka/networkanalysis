...
![Fig1: Example of a social network: Grooming and play networks of pigtail macaques (Macaca nemestrina). Photo by Frank Vincentz via wikimedia, Networks from from Flack et al. (2006).[^1]](https://www.dropbox.com/s/jec9dgm7npwgh1i/ASN_fig1.png?raw=1)
