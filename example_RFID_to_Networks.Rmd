...
Now, let's try running the `gmmevents()` function on one day's data. But we will go ahead and structure this as a for-loop so that it'll be easier to expand it to multiple days.
```{r, eval=F}
#test with one date
for(i in 1){
