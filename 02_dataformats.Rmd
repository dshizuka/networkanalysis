...
```{r}
am=as.matrix(read.csv("https://dshizuka.github.io/network2018/NAOCworkshop_SampleData/Sample_adjmatrix.csv", header=T, row.names=1))
am
```
...
```{r}
g=graph_from_adjacency_matrix(am, mode="undirected", weighted=T) g
